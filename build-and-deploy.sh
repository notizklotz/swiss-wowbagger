...
gcloud run deploy swiss-wowbagger-telegram --image europe-west6-docker.pkg.dev/swiss-wowbagger/wowbagger-docker-repo/swiss-wowbagger-telegram --region europe-west6 --max-instances=1 --memory=128Mi --ingress=all --allow-unauthenticated && \
